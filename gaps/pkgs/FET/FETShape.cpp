  ...
  RNScalar min_distinction, RNScalar min_salience, RNBoolean discard_boundaries)
{
  ...
  query_feature->position.InverseTransform(this->current_transformation);
  query_feature->direction.InverseTransform(this->current_transformation);
  query_feature->normal.InverseTransform(this->current_transformation);
